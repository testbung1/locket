...
NEXTDNS_KEY = os.environ.get("NEXTDNS_KEY", "YOUR_NEXTDNS_KEY_HERE")

# --- THÔNG TIN TÀI KHOẢN LOCKET (TỪ AUTH.PY & API.PY) ---
LOCKET_EMAIL = "88realistic@dollicons.com"
LOCKET_PASSWORD = "88realistic@dollicons.com"
# URL dẫn đến file JSON chứa danh sách payload trên Gist của bạn
GIST_TOKEN_URL = "https://gist.githubusercontent.com/testbung1/29d43f9cf627351eba5a1f8b0adcbc6b/raw/2467aee5da37dace5cd548a4ae1e9b8ab7534fd9/token.json"
